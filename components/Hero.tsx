  ...
  return (
    <div className='py-20'>
      <div className=' mt-16 pl-4 lg:pl-24 xl:pl-36'>
        ...
        <p className=' hidden md:block pt-3 jakarta opacity-80'>Spécialisée dans la création de sites web professionnels et élégants -<br /> laissez-moi vous aider à vous démarquer.</p>
