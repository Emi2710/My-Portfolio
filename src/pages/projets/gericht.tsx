  ...
  return (
    <Layout>
        <div className='jakarta py-16 px-5 text-lg leading-9'>
            ...
            <p>En tant que d&eacute;veloppeur web professionnel, j&apos;ai travaill&eacute; dur pour m&apos;assurer que le site est convivial, rapide et s&eacute;curis&eacute; pour les clients. Le site est en accord avec la charte graphique du restaurant.</p>
